...
type recvSnapTask struct {
	stream   cherrykvpb.CherryKv_SnapshotServer
	callback func(error)
}
...
func (r *snapRunner) sendSnap(addr string, msg *raft_serverpb.RaftMessage) error {
	...
	client := cherrykvpb.NewCherryKvClient(cc)
...
func (r *snapRunner) recvSnap(stream cherrykvpb.CherryKv_SnapshotServer) (*raft_serverpb.RaftMessage, error) {
