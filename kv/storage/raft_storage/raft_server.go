...
import (
	...
	"github.com/cherrison/cherrykv/kv/raftstore"
	"github.com/cherrison/cherrykv/kv/raftstore/message"
	"github.com/cherrison/cherrykv/kv/raftstore/scheduler_client"
	"github.com/cherrison/cherrykv/kv/raftstore/snap"
	"github.com/cherrison/cherrykv/kv/storage"
	"github.com/cherrison/cherrykv/kv/util/engine_util"
	"github.com/cherrison/cherrykv/kv/util/worker"
	"github.com/cherrison/cherrykv/proto/pkg/errorpb"
	"github.com/cherrison/cherrykv/proto/pkg/kvrpcpb"
...
func (rs *RaftStorage) Raft(stream cherrykvpb.CherryKv_RaftServer) error {
	for {
		msg, err := stream.Recv()
		if err != nil {
			return err
...
func (rs *RaftStorage) Snapshot(stream cherrykvpb.CherryKv_SnapshotServer) error {
	var err error
