...
func newLog(storage Storage) *Log {
	...
	return &Log{storage: storage, entries: entries, applied: lo - 1, stabled: hi, FirstIndex: lo}
}
...
func (l *Log) nextEnts() (ents []pb.Entry) {
	// Your Code Here (2A).
	// fmt.Printf("l.applied: %d, l.FirstIndex: %d\n", l.applied, l.FirstIndex)
	if len(l.entries) > 0 {
...
func (l *Log) toSliceIndex(i uint64) int {
...
func (l *Log) toEntryIndex(i int) uint64 {
